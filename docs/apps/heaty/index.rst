...
2. You need at least one radiator thermostat in each room you want to
   ...
   thermostats can be controlled the same way as radiator thermostats,
   as long as they fulfill these conditions as well. If you only have
   a switchable heater and an external temperature sensor, have a look
...
4. Heaty doesn't care about where your heating energy comes from. Whether
   ...
   when there is no radiator needing energy. Although doing so wouldn't
   be to easy depending on the energy source, I might implement such a
